...
Adapted from the prettyNEAT and WANN repo released by the Google Brain Team.
...
- mpi4py 3.0.1 (`pip install mpi4py`) -- `sudo apt install libopenmpi-dev` -- {if `mpi.h` is missing}
